...
const deleteMyClaimtags = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError(
      'There was an error clearing the claimtags. Please try again.',
      500
    )
    return next(error)
  }

  res.status(201).json({ message: 'Your claimtags have been deleted.' })
}
...
exports.getMe = getMe
exports.getMyPieces = getMyPieces
exports.getMyPacks = getMyPacks
